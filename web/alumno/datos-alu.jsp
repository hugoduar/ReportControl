      ...
      <div class="tabbable">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="1">
              <p><b>Nombre: </b><i><%out.print(Bd.getNombreAlumno(nusuario));%></i></p>
              <p><b>Apellido Paterno: </b><i><%out.print(Bd.getApellidoPaternoAlumno(nusuario));%></i></p>
              <p><b>Apellido Materno: </b><i><%out.print(Bd.getApellidoMaternoAlumno(nusuario));%></i></p>
          </div>
