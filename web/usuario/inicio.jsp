...
<html lang="es">
  ...
  <body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand">Report Control</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="#">Inicio</a></li>
              <li><a href="reporte-alu.html">Reporte</a></li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Cuenta<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="historial-alu.html">Mis reportes</a></li>
                  <li><a href="datos-alu.html">Mis Datos</a></li>
                </ul>
              </li> 
            </ul>
    ...
    <div class="container" id="contenedor">        
      <div class="row-fluid">
        <div class="span7">
            <h1>Bienvenid@, <%out.print(Bd.getNombreAlumno((String)session.getAttribute("nombreUsuario")));%></h1>
        </div>
      </div>
