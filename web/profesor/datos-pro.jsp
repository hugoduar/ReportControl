      ...
      <div class="tabbable">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="1">
              <p><b>Nombre: </b><i><%out.print(Bd.getNombreProfesor(nusuario));%></i></p>
              <p><b>Apellido Paterno: </b><i><%out.print(Bd.getApellidoPaternoProfesor(nusuario));%></i></p>
              <p><b>Apellido Materno: </b><i><%out.print(Bd.getApellidoMaternoProfesor(nusuario));%></i></p>
          </div>
